...
bool conversionCharPunto4(char *string) {
    ...
    //     if(string[1]=='\0'){    //Si el primer signo es negativo y el siguiente un vacio, significa que es solo un signo negativo
  ...
  while (flag) {
    ...
    if (scanf("%d", &tamanio) != 1) {
      ...
      printf(
          ...
          "------------------------------------||\n");
      printf(
          "\t||Entrada invalida. No se ingreso un numero entero.               "
          "                                    ||\n");
      printf(
          "\t||----------------------------------------------------------------"
          "------------------------------------||\n");

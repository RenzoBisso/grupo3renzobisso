...
NodoArbol avl_eliminar_recursivo(ArbolAVL arbol, NodoArbol nodoArbol,
    ...
    if (nodoArbol == NULL) {
        arbol->cantidad_elementos++;  // No lo encontramos, sumamos para que
    ...
    if (claveABorrar < nodoArbol->datos->clave)
        ...
        *borre = true;
        ...
        if (nodoArbol->hi == NULL && nodoArbol->hd == NULL) {
            ...
            // El nodo tiene 2 hijos, buscamos el sucesor en in-orden (o sea el
            // menor del subárbol de la derecha)

...
void interfaz2() {
    ...
    do  // MENU/////////////////////////////////////////////////
    {
        ...
        printf("\t||>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
               ">>>>>>>"
               ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>||\n");
        printf("\t||C: BUSCA TODAS LAS OCURRENCIAS DE UNA CLAVE Y RETORNA SUS "
               "POSICIONES                                ||\n");
        printf("\t||-----------------------------------------------------------"
               "-------"
               "----------------------------------||\n");
...
void interfaz3() {
    ...
    do  // MENU/////////////////////////////////////////////////
    {
        ...
        printf("\t||\n");
        printf(
            "\t|| LA ALTURA DE LA RAMA DEL NODO CON LA CLAVE '%d' ES: [%d] \n",
...
void interfaz4() {
    ...
    do  // MENU/////////////////////////////////////////////////
    {
        ...
        printf("\t||>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
               ">>>>>>>"
               ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>||\n");
        printf("\t||A: RETORNAR UNA LISTA CON EL RESULTADO DE RECORRER EL "
               "ARBOL POR "
               "ANCHURA                             ||\n");
        printf("\t||-----------------------------------------------------------"
               "-------"
        ...
        printf("\t||>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
               ">>>>>>>"
               ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>||\n");
        printf("\t||C: DETERMINA SI DOS ARBOLES N-ARIOS TIENEN LA MISMA "
               "ESTRUCTURA    "
               "                                  ||\n");
        printf("\t||-----------------------------------------------------------"
               "-------"
...
void interfaz8() {
    ...
    do  // MENU/////////////////////////////////////////////////
    {
        ...
        printf("Numero de valor minimo\n");
        pedirNumeroPos(&valorminimo);
        printf("Numero de valormaximo\n");
        pedirNumeroPos(&valormaximo);
        while (valorminimo > valormaximo) {
            printf("entrada invalida, no puede ser menor al minimo\n");
            printf("Numero de valor maximo\n");
            pedirNumeroPos(&valormaximo);
        }
        printf("Numero de cantidad de claves a generar\n");
        pedirNumeroPos(&cantidaclavesagenerar);
        Lista l = l_crear();
        l = a_ej10_comparacionarboles(N_repeticiones, valorminimo, valormaximo,
                                      cantidaclavesagenerar);
        l_mostrar(l);
        limpiarBuffer();

...
void menu(){
    ...
    do  //MENU/////////////////////////////////////////////////
    {
        ...
        printf("\t\t\t\t\t||----------------------------------||\n");     
        printf("\t\t\t\t\t||OPCION 4 - Probar ejercicio 7     ||\n");
        printf("\t\t\t\t\t||----------------------------------||\n");
        printf("\t\t\t\t\t||OPCION 5 - Probar ejercicio 8     ||\n");
        printf("\t\t\t\t\t||----------------------------------||\n");
        printf("\t\t\t\t\t||OPCION 6 - Probar ejercicio 9     ||\n");
        printf("\t\t\t\t\t||----------------------------------||\n");
        printf("\t\t\t\t\t||OPCION 7 - Probar ejercicio 10    ||\n");
        printf("\t\t\t\t\t||----------------------------------||\n");      
        ...
        do //VALIDO OPCION DEL MENU////////////////////////////////////////////////////////////
        {
            ...
            if ( bandera != 1 ||opcion < 0 || opcion > 7 )
            {
                printf("Valor invalido, reintente el ingreso...(Opciones validas entre 0 y 7)\n");
                valido = false;
            }
            fflush(stdin);
        } while (!valido);

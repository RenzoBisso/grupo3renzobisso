 ...
 */
// a.	Dado un árbol n-ario, devolver en forma de lista el resultado del
// recorrido en anchura del árbol  (solo las claves).
Lista a_ej4_anchura(ArbolBinario A);

// b.	Escribir una función que, dado un árbol n-ario, devuelva el número
// (cantidad) de hojas de dicho árbol.
int a_ej4_q_hojas(ArbolBinario A);

// c.	Escribir una función booleana que dados dos árboles generales determine
// si tienen la misma estructura, sin importar los datos del mismo (árbol
// similar).
...
/**
9.	Generar un algoritmo, recursivo o no, que permita construir un árbol
binario de búsqueda balanceado (AVL) a partir de un árbol binario sin un orden
determinado. Comparar las alturas de ambos árboles. Determinar la complejidad
algorítmica.
 */
...
árbol binario de búsqueda y en un árbol binario balanceado “AVL”. Comparar la
altura de ambos árboles. Repetir el proceso “n” veces. ¿Qué puede concluir al
respecto?
 */
...
// Este proceso se debera repetir N veces  (N se debera poder tomar por
// teclado).
